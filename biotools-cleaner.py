...
plt.scatter(data['Meas. M/z'].apply(float), data['Dev.(ppm)'].apply(float), c=data['Score'], norm=colors.LogNorm(vmax=xmax))
...
plt.scatter(hsdata['Meas. M/z'].apply(float), hsdata['Dev.(ppm)'].apply(float), c=hsdata['Score'], norm=colors.LogNorm(vmax=xmax))
plt.colorbar(label='Score')
plt.xlabel('M/z')
plt.ylabel('deviation (ppm)')
plt.ylim(-30,30)
...
plt.scatter(cleaned['Meas. M/z'].apply(float), cleaned['Dev.(ppm)'].apply(float), c=cleaned['Score'], norm=colors.LogNorm(vmax=xmax))
plt.colorbar(label='Score')
plt.xlabel('M/z')
plt.ylabel('deviation (ppm)')
plt.ylim(-30,30)
...
plt.scatter(clean['Meas. M/z'].apply(float), clean['Dev.(ppm)'].apply(float), c=clean['Score'], norm=colors.LogNorm(vmax=xmax))
plt.colorbar(label='Score')
plt.xlabel('M/z')
plt.ylabel('deviation (ppm)')
plt.ylim(-30,30)
